...
function showbook() {
  ...
  if (typeof(Storage) !== "undefined") {
    ...
    if (secondpick == "quick-listening"){
      ...
      document.getElementById('title2').innerHTML = "<p><b>FELUNDIFINED<b></p>";
    }
    ...
    if (thirdpick == "quick-listening"){
      ...
      document.getElementById('title3').innerHTML = "<p><b>FELUNDIFINED<b></p>";
    }
    ...
    if (fourthpick == "quick-listening"){
      ...
      document.getElementById('title4').innerHTML = "<p><b>FELUNDIFINED<b></p>";
    }
